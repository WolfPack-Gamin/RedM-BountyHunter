...
Payment = {
  Money = {
    ...
    Min = 7,           -- Minimal money value a player can get per kill.
    Max = 15,           -- Maximum money value a player can get per kill
...
BountyBoards = {
  ...
  { City = 'Armadillo',	   x = -3619.39, y = -2605.76, z = -13.33 },
  { City = 'Tumbleweed',   x = -5532.31, y = -2927.26, z = -1.36 },
  { City = 'Strawberry',   x = -1808.98, y = -352.45, z = 164.66 },
  { City = 'Annesburg',    x = 2906.36, y = 1309.03, z = 44.94 },
  { City = 'Rhodes',       x = 1357.83, y = -1304.29, z = 77.76}
  -- { City = 'Valentine', x = -274.8, y = 805.5, z = 119.3 },
}
--------------------------------------------------------------------------------
...
Bounties  = {
  ...
  {ID = 22, Coords = { x = -4369.42, y = -2407.77, z = 19.71   }}, --Tumbleweed / Armadillo
  {ID = 22, Coords = { x = -4354.94, y = -2434.6,  z = 19.34   }},
  {ID = 23, Coords = { x = -1426.56, y = -2283.1,  z = 43.26   }}, --Thieves Landing
}
